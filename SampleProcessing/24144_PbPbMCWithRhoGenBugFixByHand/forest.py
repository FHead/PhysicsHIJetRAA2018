...
if addRXJets :
    ...
    process.akCs1PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs1PFpatJets", genjetTag = "ak1GenJetsNoNu")
    process.akCs2PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs2PFpatJets", genjetTag = "ak2GenJetsNoNu")
    process.akCs3PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs3PFpatJets", genjetTag = "ak3GenJetsNoNu")
    print(process.akCs4PFJetAnalyzer.jetTag)
    process.akCs4PFJetAnalyzer.jetTag = cms.InputTag('akCs0PFpatJets')
    print(process.akCs4PFJetAnalyzer.jetTag)
    process.akCs5PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs5PFpatJets", genjetTag = "ak5GenJetsNoNu")
    process.akCs6PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs6PFpatJets", genjetTag = "ak6GenJetsNoNu")
    process.akCs7PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs7PFpatJets", genjetTag = "ak7GenJetsNoNu")
    process.akCs8PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs8PFpatJets", genjetTag = "ak8GenJetsNoNu")
    process.akCs9PFJetAnalyzer = process.akCs4PFJetAnalyzer.clone(jetTag = "akCs9PFpatJets", genjetTag = "ak9GenJetsNoNu")
    ...
    process.forest += process.extraJetsMC * process.akCs1PFJetAnalyzer
    process.forest += process.extraJetsMC * process.akCs2PFJetAnalyzer
    ...
    process.forest += process.extraJetsMC * process.akCs5PFJetAnalyzer
    process.forest += process.extraJetsMC * process.akCs6PFJetAnalyzer
    process.forest += process.extraJetsMC * process.akCs7PFJetAnalyzer
    process.forest += process.extraJetsMC * process.akCs8PFJetAnalyzer
    process.forest += process.extraJetsMC * process.akCs9PFJetAnalyzer
