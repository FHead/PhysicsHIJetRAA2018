...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        '/store/hidata/HIRun2018A/HIMinimumBias0/MINIAOD/PbPb18_MiniAODv1-v1/240000/8e4e6330-7861-41d9-a367-7e3ae43d714e.root'
        # '__INPUT__'
    ),
)
...
process.JetPrefilter = cms.EDFilter("PATJetFilter",
   JetTag = cms.InputTag("slimmedJets"),
   MinPT = cms.untracked.double(35),
   MinEta = cms.untracked.double(-3.2),
   MaxEta = cms.untracked.double(+3.2))
...
if addRXJets :
    ...
    # process.akCs1PFJets.jetPtMin = cms.double(40)
    # process.akCs2PFJets.jetPtMin = cms.double(40)
    # process.akCs3PFJets.jetPtMin = cms.double(40)
    # process.akCs0PFJets.jetPtMin = cms.double(40)
    # process.akCs5PFJets.jetPtMin = cms.double(40)
    process.akCs6PFJets.jetPtMin = cms.double(40)
    # process.akCs7PFJets.jetPtMin = cms.double(40)
    # process.akCs8PFJets.jetPtMin = cms.double(40)
    # process.akCs9PFJets.jetPtMin = cms.double(40)

    process.akCs4PFJetAnalyzer.jetPtMin = cms.double(40)
    process.akCs4PFJetAnalyzer.jetAbsEtaMax = cms.untracked.double(3.5)
...
process.skimanalysis.superFilters = cms.vstring('forest')
