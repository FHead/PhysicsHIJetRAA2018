...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        '/store/hidata/HIRun2018A/HIHardProbes/MINIAOD/PbPb18_MiniAODv1-v1/230000/4333b17e-66ba-4354-8420-57b32b96e06c.root'
        # '__INPUT__'
    ),
)
...
process.pAna = cms.EndPath(process.Trigger * process.skimanalysis)
