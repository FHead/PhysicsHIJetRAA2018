...
if addRXJets :
    ...
    process.akCs1PFJets.jetPtMin = cms.double(30)
    process.akCs2PFJets.jetPtMin = cms.double(30)
    process.akCs3PFJets.jetPtMin = cms.double(30)
    process.akCs0PFJets.jetPtMin = cms.double(30)
    process.akCs5PFJets.jetPtMin = cms.double(30)
    process.akCs6PFJets.jetPtMin = cms.double(30)
    process.akCs7PFJets.jetPtMin = cms.double(30)
    process.akCs8PFJets.jetPtMin = cms.double(30)
    process.akCs9PFJets.jetPtMin = cms.double(30)

    process.akCs4PFJetAnalyzer.jetPtMin = cms.double(30)
