...
do
   for C in $Centrality
   do
	   echo "RAA_R${R}_Centrality${C} JECUp_Correlation             float 0.50" >> $Config
   	echo "RAA_R${R}_Centrality${C} JECDown_Correlation           float 0.50" >> $Config
	   ...
	   echo "RAA_R${R}_Centrality${C} JERUp_Correlation             float 0.50" >> $Config
   	echo "RAA_R${R}_Centrality${C} JERDown_Correlation           float 0.50" >> $Config
	   echo "RAA_R${R}_Centrality${C} IterationUp_Correlation       float 0.25" >> $Config
   	echo "RAA_R${R}_Centrality${C} IterationDown_Correlation     float 0.25" >> $Config
...
do
   ...
   do
	   ...
	   echo "RCP_R${R}_Centrality${C} IterationUp_Correlation       float 0.50" >> $Config
   	echo "RCP_R${R}_Centrality${C} IterationDown_Correlation     float 0.50" >> $Config
	   echo "RCP_R${R}_Centrality${C} Prior_Correlation             float 0.00" >> $Config
	   echo "RCP_R${R}_Centrality${C} Iteration_Correlation         float 0.50" >> $Config
   ...
   for C in 50to90
   do
	   echo "RCP_R${R}_Centrality${C} JECUp_Correlation             float 0.9999" >> $Config
   	echo "RCP_R${R}_Centrality${C} JECDown_Correlation           float 0.9999" >> $Config
	   ...
	   echo "RCP_R${R}_Centrality${C} JERUp_Correlation             float 0.9999" >> $Config
   	echo "RCP_R${R}_Centrality${C} JERDown_Correlation           float 0.9999" >> $Config
	   echo "RCP_R${R}_Centrality${C} IterationUp_Correlation       float 0.9999" >> $Config
   	echo "RCP_R${R}_Centrality${C} IterationDown_Correlation     float 0.9999" >> $Config
	   echo "RCP_R${R}_Centrality${C} Prior_Correlation             float 0.9999" >> $Config
