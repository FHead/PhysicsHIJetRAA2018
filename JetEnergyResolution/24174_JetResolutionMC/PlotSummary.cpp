...
int main(int argc, char *argv[])
{
   ...
   for(int iEta = 0; iEta < NEtaBin; iEta++)
   {
      ...
      TGraphAsymmErrors GAverage, GMean, GRMS, GSigma;
      ...
      for(int iPT = 0; iPT < PTBinCount; iPT++)
      {
         ...
         double RMS     = DHFile[State]["CorrectedRMS"].GetDouble();
      ...
      GRMS.SetMarkerColor(Colors[0]);
      GRMS.SetLineColor(Colors[0]);
      GRMS.SetLineWidth(2);
      ...
      Legend1.AddEntry(&GRMS, "Average", "pl");
      Legend1.AddEntry(&GSigma, "Gaussian mean", "pl");
